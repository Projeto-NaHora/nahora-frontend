...
function formatLocation(cidade?: string, estado?: string): string {
...
export function FavoriteCard({
  ...
  const avatarColors = getAvatarColor(professional.id);
  const location = formatLocation(professional.cidade, professional.estado);
    ...
    >
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.ratingRow}>
          ...
          {totalReviews > 0 && (
            <Text style={styles.reviewCount}>· {totalReviews} avaliações</Text>
          )}
        </View>
      </View>
