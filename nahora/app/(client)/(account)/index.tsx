...
import { useClientProfileMenu } from "@/features/profile/hooks/useClientProfileMenu";
...
import { Colors, Fonts, FontSizes, LineHeights } from "@/constants/theme";
...
export default function Screen() {
  ...
  if (error) {
    console.error("[C01] Erro ao carregar perfil do cliente:", error);
